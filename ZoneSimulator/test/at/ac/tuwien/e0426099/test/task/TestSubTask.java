...
public class TestSubTask {
	...
	@Before
	public void setUp() {
		subTask1 = new ComputationalSubTask(UUID.randomUUID(),"TestSubTask1",new MemoryAmount(10),10l,30000l);
		subTask2 = new ComputationalSubTask(UUID.randomUUID(),"TestSubTask2",new MemoryAmount(15),15l,40000l);
		subTask3 = new ComputationalSubTask(UUID.randomUUID(),"TestSubTask3",new MemoryAmount(15),10l,5000l);
